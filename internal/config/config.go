...
type Config struct {
	...
	ResourcesLimitsMemory   string            `default:"40Mi" desc:"Init container memory limits" split_words:"true"`
	ResourcesLimitsCPU      string            `default:"100m" desc:"Init container CPU limits" split_words:"true"`
	ResourcesRequestsMemory string            `default:"40Mi" desc:"Init container requests memory limits" split_words:"true"`
