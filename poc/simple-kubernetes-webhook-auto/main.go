...
import (
	...
	"github.com/slackhq/simple-kubernetes-webhook/pkg/watcher"
...
func main() {
	...
	logrus.Print("Starting webhooks")
	...
	logrus.Print("Run watcher")
	err := watcher.WatchForCertificateUpdate(ctx, "/etc/webhook/certs")
	if err != nil {
		logrus.Fatalf("Error: %v", err)
	}
	logrus.Print("End watcher")
